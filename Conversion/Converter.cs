	...
	public class Converter : IDisposable
    {
        ...
        protected async Task<IReadOnlyList<string>> Convert(Card card)
        {
            ...
            try
            {
	            ...
	            var attachmentUrlMappings = new Dictionary<string, string>();
	            ...
	            foreach (var attachment in attachments)
	            {
					...
					try
					{
						...
						//	await gitlab.UploadAttachment(tempFilePath, fileName, attachment.MimeType);

						//attachmentUrlMappings[attachment.Url] = gitlabAttachment.Url;
					}
					finally
					{
					...
					//await gitlab.UploadAttachment(file, attachment.Name, attachment.MimeType);
	            }
